...
class WalmartSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://www.walmart.com/search/?query=luggage%20bags%20for%20travel&typeahead=luggage%20bag"
    ...
    def parse_walmart(self, response):
        ...
        Product_ID ="NA"#(response.xpath(".//div[@class='valign-middle secondary-info-margin-right copy-mini display-inline-block wm-item-number']//text()").get()).split('#')[1]  
        ...
        yield WalmartItem(Category_Name=Category_Name,Website=Website,Sub_category=Sub_category,Product_Name = Product_Name,Product_ID = Product_ID,Product_Model =Product_Model,Product_Brand = Product_Brand,Price = Price, Features = Features, Description = description_raw, Image_urls = [Img_url])
